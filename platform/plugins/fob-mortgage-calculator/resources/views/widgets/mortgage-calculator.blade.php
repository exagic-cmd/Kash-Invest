...
<div class="widget widget-mortgage-calculator">
    ...
    <div class="widget-title h7 fw-7">{{ Arr::get($config, 'name') }}</div>
    @endif
    ...
    <div class="{{ $wrapperClass }}" id="{{ $uniqueId }}" data-calculator style="{{ $inlineStyle }}">
        ...
        <div class="mortgage-calculator__header">
            @if($formTitle)
            <div class="mortgage-calculator__title">{{ $formTitle }}</div>
            @endif
            @if($formDescription)
            ...
            <div class="mortgage-calculator__results-panel" data-results>
                ...
                <div class="mortgage-calculator__results-content">
                    ...
                    <div class="mortgage-calculator__empty-state" data-empty-state>
                        <div class="mortgage-calculator__empty-state-title">
        ...
        <div class="mortgage-calculator__modal-content">
            <div class="mortgage-calculator__modal-header">
                <div class="mortgage-calculator__modal-title">{{ trans('plugins/fob-mortgage-calculator::fob-mortgage-calculator.amortization.title') }}</div>

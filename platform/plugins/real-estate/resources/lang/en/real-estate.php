...
return [
    ...
    'theme_options' => [
        ...
        'location_seo' => 'Location SEO Templates',
        'location_seo_description' => 'Configure auto-generated SEO metadata for location pages. Use placeholders like {City}, {State}, {ZIP}, {Country}, {site_name} to dynamically insert location data. Leave empty to use default templates.',
        'city_seo_title' => 'City Page SEO Title Template',
        'city_seo_description' => 'City Page SEO Description Template',
        'state_seo_title' => 'State Page SEO Title Template',
        'state_seo_description' => 'State Page SEO Description Template',
        'seo_placeholders_help' => 'Available placeholders: {City}, {State}, {ZIP}, {Country}, {state_abbr}, {site_name}',
    ],
    'email_templates' => [
        // Common field labels
        'field_name' => 'Name:',
    ...
    'agents' => 'Agents',
    'projects_in_city' => 'Projects in :city',
    'properties_in_city' => 'Properties in :city',
    'projects_in_state' => 'Projects in :state',
    'properties_in_state' => 'Properties in :state',
    ...
    'area_unit_ft2' => 'ft2',
    'area_unit_yd2' => 'yd2',
    'edit_property' => 'Edit this property',
    'edit_project' => 'Edit this project',
    'edit_agent' => 'Edit this agent',
    'property_no_longer_available' => 'Property No Longer Available: :name',
    'property_listing_expired' => 'This property listing has expired',
    'property_listing_no_longer_available' => 'This property listing is no longer available',
    'property_expired_title' => 'Property Expired: :name',
];

...
class ProjectForm extends FormAbstract
{
    public function setup(): void
    {
        ...
        $this
            ...
            // Landing pages are now assigned and edited from their own admin page
            // (Real Estate → Landing Pages), so the in-form dropdown was removed.
            // The landing_template column still drives which projects render a
            // landing page; that page manages it.
            // Unit & Suite Details
